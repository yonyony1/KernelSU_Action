...
@@ -120,7 +136,9 @@ ccflags-y += -DKSU_VERSION=$(KSU_VERSION)
 else
...
diff --git a/kernel/compat/samsung_defex.c b/kernel/compat/samsung_defex.c
new file mode 100644
index 0000000..bd384dc
--- /dev/null
...
+#endif
+}
diff --git a/kernel/compat/samsung_defex.h b/kernel/compat/samsung_defex.h
new file mode 100644
index 0000000..f635af6
--- /dev/null
...
+#endif
+}
diff --git a/kernel/core/init.c b/kernel/core/init.c
index e9cd102..62ed640 100644
...
@@ -85,6 +87,8 @@ module_param_named(norc, ksu_no_custom_rc, bool, 0);
...
@@ -120,13 +124,29 @@ int __init kernelsu_init(void)
...
+
     ...
     ksu_feature_init();
@@ -213,7 +233,9 @@ void __exit kernelsu_exit(void)
     ksu_sulog_exit();
     ksu_feature_exit();
...
@@ -318,6 +322,149 @@ static int my_sel_open_handle_status(struct inode *inode, struct file *filp)
     return ret;
 }
...
@@ -351,39 +498,101 @@ static int ksu_selinux_hide_enable()
...
+#endif
     ...
     if (orig_context_write) {
         ret =
@@ -475,6 +684,8 @@ void ksu_selinux_hide_handle_post_fs_data()
...
@@ -485,9 +696,23 @@ static void hook_selinux_status_open()
         }
...
diff --git a/kernel/hook/arm64/patch_memory.c b/kernel/hook/arm64/patch_memory.c
index 670f3bd..8e53eb3 100644
...
+#endif
 ...
 /*
diff --git a/kernel/hook/arm64/syscall_hook.c b/kernel/hook/arm64/syscall_hook.c
index f8d052c..15c2424 100644
...
@@ -209,6 +218,12 @@ void __init ksu_syscall_hook_init(void)
...
@@ -216,7 +231,11 @@ void __init ksu_syscall_hook_init(void)
     }
...
diff --git a/kernel/hook/syscall_hook.h b/kernel/hook/syscall_hook.h
index 944f43f..f6abeac 100644
...
diff --git a/kernel/hook/syscall_hook_manager.c b/kernel/hook/syscall_hook_manager.c
index e5b179e..039c83e 100644
...
@@ -126,6 +425,19 @@ void __init ksu_syscall_hook_manager_init(void)
     int ret;
...
@@ -157,6 +469,15 @@ void __init ksu_syscall_hook_manager_init(void)
...
diff --git a/kernel/hook/tp_marker.c b/kernel/hook/tp_marker.c
index c78bbbd..5666403 100644
...
diff --git a/kernel/include/ksu_samsung_kdp.h b/kernel/include/ksu_samsung_kdp.h
new file mode 100644
index 0000000..9cdbc81
--- /dev/null
...
+
+#endif
diff --git a/kernel/policy/app_profile.c b/kernel/policy/app_profile.c
index 518ef41..13bfa13 100644
...
diff --git a/userspace/ksud/src/late_load.rs b/userspace/ksud/src/late_load.rs
index 8e6f0fe..6708ac2 100644
...
@@ -35,11 +35,14 @@ fn dump_process_info(label: &str) {
     );
 }
...
@@ -78,7 +81,7 @@ pub fn run(package_name: &String, kmi: Option<String>, allow_shell: bool) -> Res
...
@@ -129,18 +132,5 @@ pub fn run(package_name: &String, kmi: Option<String>, allow_shell: bool) -> Res
...
@@ -231,15 +232,42 @@ fn link_ksud_to_bin() -> Result<()> {
     Ok(())
 }
...
@@ -277,6 +305,11 @@ pub fn install(libadbroot: Option<PathBuf>, data_path: Option<PathBuf>) -> Resul
     Ok(())
 }
...
@@ -321,10 +354,6 @@ pub fn daemonize_with<F: FnOnce() -> Result<()>>(use_init_pgrp: bool, configure:
     Ok(())
 }
